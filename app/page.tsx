        ...
        <div className="container mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? "animate-slide-up" : "opacity-0"}`}>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Seamlessly manage your medications, set personalized reminders, and track your health with RxCare - your
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button
                variant="outline"
                size="lg"
                className="border-blue-200 text-blue-700 hover:bg-blue-50 px-8 py-4 text-lg bg-transparent"
              >
                Learn More
              </Button>
            </div>
            ...
            <Card className="border-blue-100 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 leading-relaxed text-sm break-words">
                  Set dose times & refill alerts, customize schedules, and get timely notifications so you never forget.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of users who trust RxCare to manage their medications safely and effectively.
          </p>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold font-serif text-gray-800">RxCare</span>
              </div>
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center">
            <p className="text-sm text-gray-600">
              Emergency Contact: +1 (800) 123-4567 | © 2025 RxCare. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
