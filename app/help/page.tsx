      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            {/* Welcome Banner */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 text-white mb-8 shadow">
              <h2 className="text-xl font-semibold mb-2">
                Welcome to RxCare Help & Support
              </h2>
              <p className="text-blue-100">
                Explore our resources or connect with our team for assistance.
                We're here to help you manage your prescriptions effectively.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
              {/* FAQs */}
              <Link href="/help/faq">
                <div className="h-full flex flex-col bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition cursor-pointer group">
              ...
              {/* Email Assistance */}
              <div
                className="h-full flex flex-col bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition cursor-pointer group"
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Opens Gmail with our support email pre-filled.
                </p>
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 items-stretch">
              ...
              <Link href="/help/feedback">
                <div className="h-full flex flex-col bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition cursor-pointer">
                  <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
                    <MessageSquare className="w-5 h-5 mr-2 text-green-600" />
                    Feedback Form
                  </h3>
                  <p className="text-gray-600 text-sm mb-4">
                    Share your thoughts and help us improve RxCare.
                  </p>
